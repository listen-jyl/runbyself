...
def magnumNext(html):
    ...
    for n in nextname:
        nexturl = tt.xpath('//a[contains(text(), "%s")]/@href' % n)
        if nexturl:
            return nexturl[0]
...
if __name__ == "__main__":
    #  text = ''.join(open('./ttt.html').readlines())
    #  getResponse("https://www.baidu.com")
    #  magnumNext(text)
    #  print(getRandUserAgent())
    print(randUserAgent(1))
